...
//Librerie VIMEO API
require("/home/cagliarinews24.com/htdocs/vimeophp/autoload.php");
...
function register_button($buttons) {
   array_push($buttons, "video_cagl24");
   return $buttons;
}

function add_plugin($plugin_array) {
   $plugin_array['video_cagl24'] = get_stylesheet_directory_uri().'/js/customcodes.js';
   return $plugin_array;
}
...
wp_enqueue_script( 'video_cagl24_js', get_stylesheet_directory_uri().'/js/video_cagl24.js' );
function video_cagl24($atts, $content = null) {
...
add_shortcode("video_cagl24", "video_cagl24");
// END Video JS Engine | ARTICOLO


// Sliding Player
function videoslide_cagl24($atts, $content = null) {
...
/*
  ...
  if (!isMobileNewtek && homepageURL=="http://www.cagliarinews24.com/") {
    var prerollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/cagliarinews24/hp/preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=cagliarinews24.com&description_url=cagliarinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var postrollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/cagliarinews24/hp/postroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=cagliarinews24.com&description_url=cagliarinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var prerollTagSidebarRepeat = prerollTagSidebar;
    var dfpSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/165059490/Cagliarinews24_Preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=cagliarinews24.com&description_url=cagliarinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var mediamaticSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/1028390/cagliarinews.24.TM.preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=cagliarinews24.com&description_url=cagliarinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var mediamaticFallbackSidebar = 'https://ad.360yield.com/advast?p=885164&w=16&h=9';
  } else if (!isMobileNewtek) {
    var prerollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/cagliarinews24/altro/preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=cagliarinews24.com&description_url=cagliarinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var postrollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/cagliarinews24/altro/postroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=cagliarinews24.com&description_url=cagliarinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var prerollTagSidebarRepeat = prerollTagSidebar;
    var dfpSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/165059490/Cagliarinews24_Preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=cagliarinews24.com&description_url=cagliarinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var mediamaticSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/1028390/cagliarinews.24.TM.preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=cagliarinews24.com&description_url=cagliarinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var mediamaticFallbackSidebar = 'https://ad.360yield.com/advast?p=885164&w=16&h=9';
  } else {
    var prerollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/cagliarinews24/mobile/preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=cagliarinews24.com&description_url=cagliarinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var postrollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/cagliarinews24/mobile/postroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=cagliarinews24.com&description_url=cagliarinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var prerollTagSidebarRepeat = prerollTagSidebar;
    var dfpSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/165059490/Cagliarinews24_Preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=cagliarinews24.com&description_url=cagliarinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var mediamaticSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/1028390/cagliarinews.24.TM.preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=cagliarinews24.com&description_url=cagliarinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
    var mediamaticFallbackSidebar = 'https://ad.360yield.com/advast?p=885164&w=16&h=9';
  ...
  var settings = {
    logo: '<?php //echo site_url(); ?>/wp-content/themes/Newspaper-child/images/logo-cagl24-video.png',
    logoLoc: '<?php //echo site_url(); ?>/',
    licenseKey: 'dG54dHd4aXh6aEAxNTA5NDU3',
    pathToRmpFiles: '//cdn.sportreview.it/radiantmp/latest/',
    gaTrackingId: 'UA-11488352-5',
  ...
  */
  ...
  <!-- Mediamatic | Special - 307x220 | 395 & 394 -->
  <div id='sy_76805' align='center'></div>
  <script>
    ...
    mmTag.push({mmSetPubId:394});
      mmTag.push({mmSetWeight:307});
      mmTag.push({mmSetHeight:220});
      }
    mmTag.push({mmSetDivId:'sy_76805'});
  ...
  add_shortcode("videoslide_cagl24", "videoslide_cagl24");
  //END Sliding Player


// Video Playlist
function video_playlist_cagl24($atts, $content = null) {
  ...
  <div class="td-container playlist-container">
    ...
    <h2 class="video-playlist-title">Video</h2>
      ...
      <script>
        ...
        var elementID2 = 'SportreviewPlaylist';
        var rmpContainer = new RadiantMP(elementID2);
...
add_shortcode("video_playlist_cagl24", "video_playlist_cagl24");
...
function adv_libs() { ?>
  ...
  if (!isMobileNewtek) {
    googletag.cmd.push(function() {
      googletag.defineSlot('/21624773413/Cagliarinews24.com/Mpu_Middle', [300, 250], 'div-gpt-ad-Mpu_Middle').addService(googletag.pubads());
      ...
      googletag.defineSlot('/67970281/display_thirdparty_it/cagliarinews24_responsive/homepage/top_banner', [[1056, 250], [728, 90], [980, 250], [970, 250]], 'div-gpt-ad-1521734859020-2').setTargeting('Display_Ad_Position', ['ATF']).addService(googletag.pubads());
      ...
      googletag.defineSlot('/67970281/display_thirdparty_it/cagliarinews24_responsive/homepage/top_mpu', [[300, 600], [300, 250]], 'div-gpt-ad-1521734859020-3').setTargeting('Display_Ad_Position', ['ATF']).addService(googletag.pubads());
...
jQuery("#div-gpt-ad-1521734859020-1").hide();
}
</script>
</div>
  <?php } else { ?>
    ...
    <div id='div-gpt-ad-1521734934648-1' style='height:1px; width:1px;'>
      <script>
        if (!isMobileNewtek) {
          ...
          jQuery("#div-gpt-ad-1521734934648-1").hide();
        }
      </script>
    </div>
  <?php }
...
<script>
        if (isMobileNewtek) {
          ...
          jQuery("#div-gpt-ad-1521734859020-0").hide();
        }
      </script>
    </div>
  <?php } else { ?>
    ...
    <div id='div-gpt-ad-1521734934648-0'>
      <script>
        if (isMobileNewtek) {
          ...
          jQuery("#div-gpt-ad-1521734934648-0").hide();
        }
      </script>
    </div>
  <?php }
...
function adv_top_mobile() { ?>
  <!-- /67970281/display_thirdparty_it/cagliarinews24_responsive/homepage/top_mpu -->
...
function adv_mpu_middle() { ?>
  <!-- /21624773413/Cagliarinews24.com/Mpu_Middle -->
...
<script>
        if (isMobileNewtek) {
          ...
          jQuery("#div-gpt-ad-1521734859020-2").hide();
        }
      </script>
    </div>
  <?php } else { ?>
