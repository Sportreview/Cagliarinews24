...
';
    ...
    // La Query
    $the_query = new WP_Query( array( 'cat' => 41, 'posts_per_page' => 10 ) );
    ...
    if ($detect->isMobile()) {
      $adtagurl = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/cagliarinews24/mobile/preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=cagliarinews24.com&description_url=cagliarinews24.com&correlator='.mt_rand(10000000000,99999999999).'';
    } else {
      $adtagurl = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/cagliarinews24/hp/preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=cagliarinews24.com&description_url=cagliarinews24.com&correlator='.mt_rand(10000000000,99999999999).'';
    }

    

    $vimeoArr = get_the_content();
      if (strpos($vimeoArr, '[video_cagl24 url="') !== false ) {

        //Url
        $vimeoArr = explode('[video_cagl24 url="', get_the_content());
